...
SELECT extract('timezone' from '2019-12-01 18:37:12 EST'::timestamptz) AS "tz";
...
COPY nyc_yellow_taxi_trips_2016_06_01 (
   ...
   FROM 'C:\Users\User\Desktop\postgresql-main\practical-sql-main\Chapter_11\yellow_tripdata_2016_06_01.csv'
